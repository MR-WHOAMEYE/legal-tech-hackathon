            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
                <ScrollView contentContainerStyle={styles.scrollContent}>
                    ...
                    <View style={styles.formCard}>
                        ...
                        >
                            ...
                            <View style={styles.inputGroup}>
                                <Hash color="#0c4651" size={20} style={styles.inputIcon} />
                                <TextInput
                                    style={styles.input}
                                    placeholder="0x..."
                    ...
                    <View style={styles.infoCard}>
                        <LinearGradient 
                            colors={['rgba(255,65,3,0.1)', 'rgba(12,70,81,0.05)']} 
...
const styles = StyleSheet.create({
    ...
    iconRing: {
        ...
        borderWidth: 2, borderColor: 'rgba(12,70,81,0.3)',
        justifyContent: 'center', alignItems: 'center',
        marginBottom: 20,
    },
    iconGradient: {
    ...
    scanText: { color: '#ff4103', fontSize: 14, fontWeight: '600', marginLeft: 8 },
    infoCard: {
        borderRadius: 16, overflow: 'hidden',
        borderWidth: 1, borderColor: 'rgba(255,65,3,0.15)',
    },
